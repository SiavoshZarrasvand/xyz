            ...
            <div className="overflow-x-auto border border-border rounded-lg">
              <table className="w-full text-left">
                <thead className="bg-muted/50">
                  <tr>
                    <th className="px-4 py-3 text-sm font-semibold text-foreground w-[240px]">Company & Stand</th>
                    <th className="px-4 py-3 text-sm font-semibold text-foreground min-w-[340px]">Cosmetics Focus & Description</th>
                    <th className="px-4 py-3 text-sm font-semibold text-foreground w-[180px]">Contacts</th>
                    <th className="px-4 py-3 text-sm font-semibold text-foreground w-[180px]">Location</th>
                          ...
                          <div className="flex flex-col gap-1.5">
                            { exhibitor.website && (
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="text-primary hover:underline flex items-center gap-1.5 truncate max-w-[170px]"
                            ...
                            { !exhibitor.website && !exhibitor.email && !exhibitor.phone && (
